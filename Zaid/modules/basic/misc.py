...
alive_logo = ALIVE_PIC or "https://graph.org/file/a2015f8e3888b2ee25478.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [𝗕𝗟𝗢𝗢𝗗𝗬 𝗗𝗔𝗗𝗗𝗬-𝗪𝗢𝗥𝗟𝗗](t.me/selfishworld47)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: [𝗕𝗟𝗢𝗢𝗗𝗬 𝗗𝗔𝗗𝗗𝗬](t.me/ORTHODOXALLBOTS)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [𝗕𝗟𝗢𝗢𝗗𝗬 𝗗𝗔𝗗𝗗𝗬](t.me/IAMBLODDYDADDY )"        
    )
...
async def creator(bot: Client, message: Message):
    await message.edit("https://github.com/gamechanger4447")
