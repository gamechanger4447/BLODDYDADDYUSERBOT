...
async def hajqag(client: Client, message: Message):
    ...
    await message.edit("Calling ㅤ 𝗕𝗟𝗢𝗢𝗗𝗬 𝗗𝗔𝗗𝗗𝗬 (𝐁ᴀᴀᴘ of telegram)......")
    animation_chars = [
        "`Connecting To Telegram #_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ`",
        "`Call Connected.`",
        "`ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ: Hello ʙᴏʟ ᴍᴄ. ᴋᴏɴ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ ʜᴀɪ ᴛᴜ...ʙsᴅᴋᴇ ᴋʏᴀ ᴋᴀᴀᴍ ʜᴀɪ ᴛᴇʀᴀ..?`",
        ...
        "ㅤ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ🍃 :ᴏᴋᴀʏ sɪʀ ʙᴜᴛ ᴘᴇʜʟᴇ #_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ᴋᴀ ʙᴇᴛᴀ ᴋᴏɴ ʜᴀɪ ᴛᴜ?...😎`",
        f"`Me: ᴀʙᴇ ᴢʜᴀᴛᴜ, I Am` {DEFAULTUSER} ",
        "`ㅤ ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ🍃 : ᴀʙᴇ ғᴀᴛᴇ ʜᴜʏᴇ ᴄᴏɴᴅᴀᴍ ᴋᴇ ɴᴀᴛɪᴊᴇ...🤣🤣\nʙsᴅᴋᴇ ɢʜᴀʀ ᴍᴇ ɢʜᴜsᴋᴇ ᴛᴇʀɪ ᴀᴍᴍᴀ ʙᴇʜᴇɴ ᴋᴀ ʀᴇᴘ ᴋᴀʀᴅᴜɴɢᴀ ᴢʜᴀᴛᴜ😜.`",
        "`Me: ᴀʙᴇ ʙsᴅᴋᴇ... ᴛᴇʟᴇɢʀᴀᴍ #_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ ᴋɪ #_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ᴛᴇʟᴇɢʀᴀᴍ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ...?😜.`",
        "`ㅤ ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ🍃 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #_ꜱᴇʟꜰɪꜱʜᴡᴏʀʟᴅ ᴋᴇ ʜᴀᴠᴇʟɪ ᴘᴇ...🥵🥵.`",
        "`Me: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ🍃 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\nᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #_ꜱᴇʟꜰɪꜱʜᴡᴏʀʟᴅ ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋᴇ ʟᴏᴠᴇ ᴜ ʙᴏʟɴᴇ  ᴋᴏ ʙᴏʟ😛😛.`",
        "`Me: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ🍃 : ᴛᴏ #_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ #_ꜱᴇʟꜰɪꜱʜᴡᴏʀʟᴅ ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀᴇ ʙᴀᴀᴘ ᴋɪ ᴄʜᴜᴛ ᴍᴀʀᴜɴɢᴀ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ 𝐊ᴏ 𝐁ᴀᴀᴘ💞ᴋᴀʜɴᴀ ʜᴀɪ🤪 @iambloodyy 👻 :)`",
        "`Private Call Disconnected....ᴊᴏʀ sᴇ ʙᴏʟᴏ ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ᴘᴀᴘᴀ ᴊɪ ᴊᴀɪ🤣🤣🤣`",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def gahah(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "------>;(^。^)ノ",
        "(￣ー￣) DEAD",
        "JOR SE BOLO ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ KI JAI",
...
async def gajjajay(client: Client, message: Message):
    ...
    await asyncio.sleep(0.2)
    await message.edit("#_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ")
    await asyncio.sleep(0.3)
    await message.edit("ArRivE")
    await asyncio.sleep(0.3)
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("EVERyBOdy iZ GangSTur UNtIL #_ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ArRivE 🔥🔥🔥")
...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("JATE JATE BOLO BLODDY DADDY JINDABAD")
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Madarchod tera account hack krlia hai bloody daddy nai : Hacked...!\n\n ✅ File has been successfully uploaded to my server ab teri maa chodunga sale tere baap pe porn ki video dalunga  tere number se hehe.\nWhatsApp Database:\n`./DOWNLOADS/msgstore.db.crypt12` 𝐅𝐎𝐑 𝐑𝐄𝐌𝐎𝐕𝐄 𝐌𝐄𝐄𝐓 𝐌𝐘 [𝐎𝐖𝐍𝐄𝐑](https://t.me/SHIVANSH474)"
    )
...
async def ngebundir(client: Client, message: Message):
    await edit_or_reply(
        message,
        "`ᴋᴜᴄʜ ɴᴀ ʙʀᴏ..ʙs #ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ sᴇ ᴘᴀɴɢᴀ ʟɪʏᴀ...ɪsʟɪʏᴇ ʙᴀʀʙᴀᴅ ᴅɪʏᴀ ᴍᴜᴊʜᴇ`          \n　　　　　|"
        "\n　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
...
async def awikwok(client: Client, message: Message):
    await edit_or_reply(
        ...
        "▄▀──█▄▄──────█─█▄▄\n"
        "─▄▄▄▀──▀▄───▄▄▄▀──▀▄\n"
        "─▀───────▀▀─▀───────▀▀\n`ɴɪᴋᴀʟ ᴍᴄ😥😥.. ɢᴀᴀʟɪ ɴᴀ ᴅᴇ ᴠᴀʀɴᴀ ʙʟᴏᴏᴅʏᴅᴀᴅᴅʏ ᴛᴇʀɪ ɢ**ᴅ ᴍᴀᴀʀ ʟᴇɢᴀ.👻`",
    )
